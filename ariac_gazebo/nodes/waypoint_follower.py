...
from ariac_gazebo.robot_navigator import BasicNavigator, NavigationResult  # Helper module
...
def main():
  ...
  goal_pose.header.frame_id = 'map'
  goal_pose.header.stamp = navigator.get_clock().now().to_msg()
  goal_pose.pose.position.x = -7.895020
  goal_pose.pose.position.y = -11.881800
  goal_pose.pose.position.z = 0.0
  goal_pose.pose.orientation.x = 0.0
  goal_pose.pose.orientation.y = 0.0
  ...
  goal_pose.header.frame_id = 'map'
  goal_pose.header.stamp = navigator.get_clock().now().to_msg()
  goal_pose.pose.position.x = -9.757860
  goal_pose.pose.position.y = -1.440630
  goal_pose.pose.position.z = 0.0
  goal_pose.pose.orientation.x = 0.0
  goal_pose.pose.orientation.y = 0.0
  ...
  goal_pose.header.frame_id = 'map'
  goal_pose.header.stamp = navigator.get_clock().now().to_msg()
  goal_pose.pose.position.x = 1.959780
  goal_pose.pose.position.y = 0.254307
  goal_pose.pose.position.z = 0.0
  goal_pose.pose.orientation.x = 0.0
  goal_pose.pose.orientation.y = 0.0
  goal_pose.pose.orientation.z = 0.92
  ...
  while not navigator.isTaskComplete():
    ...
    if feedback and i % 5 == 0:
      ...
      if now - nav_start > Duration(seconds=500000.0):
        ...
        goal_pose_alt.pose.position.x = -18.5
        goal_pose_alt.pose.position.y = -10.2
