...
def main():
    ...
    parser.add_argument('-n', '--robot_name', type=str, default='human1',
                        help='Name of the robot to spawn')
    parser.add_argument('-ns', '--robot_namespace', type=str, default='human1',
    ...
    if args.turtlebot_type is not None:
        sdf_file_path = os.path.join(
            get_package_share_directory('ariac_human'), 'models', 'human', 'model.sdf')
    else:
