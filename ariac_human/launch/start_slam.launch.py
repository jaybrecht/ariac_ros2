...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('ariac_human')
   
    
    namespace = ''
    params_file = os.path.join(bringup_dir, 'config', 'human_params.yaml')
    autostart = 'true'
    use_sim_time = 'true'
    ...
    #     'params_file',
    #     default_value=os.path.join(bringup_dir, 'config', 'human_params.yaml'),
    ...
    ld.add_action(start_broadcaster)
