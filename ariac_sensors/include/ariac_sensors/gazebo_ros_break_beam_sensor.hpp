...
#ifndef GAZEBO_ROS_BREAK_BEAM_SENSOR_HPP_
#define GAZEBO_ROS_BREAK_BEAM_SENSOR_HPP_
...
/**
  ...
  \endcode
*/
class GazeboRosBreakBeamSensor : public gazebo::SensorPlugin
{
public:
  /// \brief Constructor
  GazeboRosBreakBeamSensor();

  /// \brief Destructor
  virtual ~GazeboRosBreakBeamSensor();

  // Documentation Inherited
  void Load(gazebo::sensors::SensorPtr _parent, sdf::ElementPtr _sdf);

private:
  std::unique_ptr<GazeboRosBreakBeamSensorPrivate> impl_;
};

}  // namespace ariac_sensors

#endif  // GAZEBO_ROS_BREAK_BEAM_SENSOR_HPP_