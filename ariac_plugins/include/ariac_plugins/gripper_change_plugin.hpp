#ifndef ARIAC_PLUGINS__GRIPPER_CHANGE_PLUGIN_HPP_
#define ARIAC_PLUGINS__GRIPPER_CHANGE_PLUGIN_HPP_
...
class GripperChangePlugin : public gazebo::VisualPlugin
{
public:
  /// Constructor
  GripperChangePlugin();
...
private:
  ...
  /// data members.
  std::unique_ptr<GripperChangePluginPrivate> impl_;
};
}  // namespace ariac_plugins

#endif  // ARIAC_PLUGINS__GRIPPER_CHANGE_PLUGIN_HPP_